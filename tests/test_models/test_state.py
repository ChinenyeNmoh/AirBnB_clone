...
class TestStateModel(unittest.TestCase):
    ...
    def test_basic_attribute_set(self):
        ...
        """
        self.temp_b.name = "benedict"
        self.temp_b.xyz = 40
        self.assertEqual(self.temp_b.name, "benedict")
        self.assertEqual(self.temp_b.xyz, 40)
    ...
    def test_from_dict_hard(self):
        ...
        """
        self.temp_b.string = "hello you!"
        self.temp_b.no = 25
        my_dict = self.temp_b.to_dict()
        self.assertEqual(my_dict['no'], 25)
        my_base = self.temp_b.__class__(**my_dict)
        self.assertEqual(my_base.no, self.temp_b.no)
        self.assertEqual(my_base.string, self.temp_b.string)
        self.assertEqual(my_base.created_at, self.temp_b.created_at)
